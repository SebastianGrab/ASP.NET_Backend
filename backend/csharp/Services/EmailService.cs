...
public class EmailService : IEmailService
{
    ...
    public bool SendPasswordUpdateEmail(string name, string to, string password)
    {
        var htmlBody = 
        @"<p>Hallo " + name + @",</p>
        <p>ihr Passwort wurde zur&uuml;ckgesetzt.</p>
        <p>Die folgenden Anmeldedaten erm&ouml;glichen Ihnen von nun an den Zugang zu Ihrem Konto.</p>
